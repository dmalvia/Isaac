$(function () {
    ...
    $(window).on('load resize', function (e) {
        ...
        if (window.innerWidth < mobileBreakpoint) {
            ...
            // If summary explorer is expanded by default on mobile, set height to enable animation on collapse
            if($('.summary-explorer').hasClass('summary-explorer--expanded')) {
    ...
    function showMoreClickAction() {
        $('[data-accordion-expand-target]').click(function (e) {
            ...
            // Scrolls to the top of section when expand/collapse link is clicked
            if (window.innerWidth < mobileBreakpoint) {

                setTimeout(function(){
                    $('html, body').animate({
                        scrollTop: $accContentHolder.offset().top
                    }, 1000);
                  }, 500);
        ...
        resizeTimer = setTimeout(function () {
            ...
            $openSections.each(function () {
                ...
                if (window.innerWidth < mobileBreakpoint) {
                    ...
                    if($('.summary-explorer').hasClass('summary-explorer--expanded')) {
                        $('.accordion-content-show-more').text('Show less');
                    } else {
